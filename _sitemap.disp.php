...
echo '<h3 class="evo_title_widget">'.T_('Common links').'</h3>';
...
echo '<h3 class="evo_title_widget">'.T_('Pages').'</h3>';
// --------------------------------- START OF PAGE LIST --------------------------------
skin_widget( array(
	// CODE for the widget:
...
echo '<h3 class="evo_title_widget">'.T_('Categories').'</h3>';
...
echo '<h3 class="evo_title_widget">'.T_('Posts').'</h3>';
// --------------------------------- START OF POST LIST --------------------------------
skin_widget( array(
	// CODE for the widget:
